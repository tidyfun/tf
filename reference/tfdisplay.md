...
#> irregular tfd[4]: [0,1] -> [-1,1] based on 30 to 49 (mean: 42) evaluations each
#> interpolation by tf_approx_linear 
#> [1]: (0.015,1.00);(0.020,1.00);(0.035,0.99); ...
#> [2]: ( 0.00,1.00);( 0.01,1.00);( 0.05,0.95); ...
#> [3]: (0.015,0.99);(0.075,0.76);(0.105,0.55); ...
#> [4]: (0.005,1.00);(0.045,0.84);(0.055,0.77); ...
