...
- ...:
  ...
  [`tfb_mv()`](https://tidyfun.github.io/tf/reference/tfb_mv.md), a
...
[`tfb_fpc()`](https://tidyfun.github.io/tf/reference/tfb_fpc.md) objects
with shared per-curve scores; `is_tfb_mfpc()` is `TRUE` for it. Use
`tf_mfpc_scores()` and `tf_mfpc_efunctions()` to extract the shared
...
[`tfb_fpc()`](https://tidyfun.github.io/tf/reference/tfb_fpc.md) /
[`fpc_wsvd()`](https://tidyfun.github.io/tf/reference/fpc_wsvd.md)) on
each component to obtain univariate scores \\\xi^{(j)}\\ and
...
[`tfb_mv()`](https://tidyfun.github.io/tf/reference/tfb_mv.md) whose
components are
[`tfb_fpc()`](https://tidyfun.github.io/tf/reference/tfb_fpc.md) objects
