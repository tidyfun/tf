...
- data:
  ...
  [`tfd()`](https://tidyfun.github.io/tf/reference/tfd.md)); a 3-d
...
- ...:
  ...
  [`tfd()`](https://tidyfun.github.io/tf/reference/tfd.md) constructor.
...
[`tfd()`](https://tidyfun.github.io/tf/reference/tfd.md) vectors (one
per output dimension / component), each of length `n`. All numeric work
(evaluation, arithmetic, smoothing, ...) is delegated to these
...
[`tfb_mv()`](https://tidyfun.github.io/tf/reference/tfb_mv.md) for a
...
[tf_mv_unimplemented](https://tidyfun.github.io/tf/reference/tf_mv_unimplemented.md);
...
[`is_tf_1d()`](https://tidyfun.github.io/tf/reference/tfmethods.md): it
returns `TRUE` for `tfd` / `tfb` and `FALSE` for `tfd_mv` / `tfb_mv`.

## See also

[`tfb_mv()`](https://tidyfun.github.io/tf/reference/tfb_mv.md) for basis
representation;
