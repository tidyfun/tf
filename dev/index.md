# tf [![tf website](https://github.com/tidyfun/tidyfun/blob/master/man/figures/logo.gif?raw=true)](https://tidyfun.github.io/tf/)
...
[`c()`](https://rdrr.io/r/base/c.html), etc.) as well as several new
functions in `tf` that implement operations specific for *functional*
data (`tf_smooth`, `tf_derive`, `tf_integrate`, `tf_register`, …).
...
Note that
[`is_tf()`](https://tidyfun.github.io/tf/dev/reference/tfmethods.md) is
`TRUE` for `tf_mv` as well; use the new
[`is_tf_1d()`](https://tidyfun.github.io/tf/dev/reference/tfmethods.md)
to test specifically for univariate `tf`.
