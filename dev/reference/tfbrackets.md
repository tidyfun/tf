...
[`tfd()`](https://tidyfun.github.io/tf/dev/reference/tfd.md) and
[`tfb()`](https://tidyfun.github.io/tf/dev/reference/tfb.md). See
details.  
...
- j:
  ...
  [tf_arg(x)](https://tidyfun.github.io/tf/dev/reference/tfmethods.md).
