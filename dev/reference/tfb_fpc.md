...
return object of
[`fpc_wsvd()`](https://tidyfun.github.io/tf/dev/reference/fpc_wsvd.md)
can be used for the `method` argument, see example below. Note that the
mean function, with a fixed "score" of 1 for all functions, is used as
the first basis function for all FPC bases.
